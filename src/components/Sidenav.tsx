...
const Sidenav: Component = () => {
  return (
    <>
      ...
      <section class="pt-[65px] relative h-screen min-h-full border bg-gray-50">
        {/* <!-- Sidenav --> */}
        <nav
          id="sidenav-4"
          class="absolute top-[65px] left-0 z-[1035] h-full w-60 px-3 py-4 -translate-x-full overflow-hidden bg-white data-[te-sidenav-hidden='false']:translate-x-0"
        ...
        >
          <ul class="relative list-none" data-te-sidenav-menu-ref>
            <li class="relative">
              <a
                href="/dashboard"
                class="flex items-center rounded-lg p-2 text-base font-normal text-gray-500 hover:bg-gray-100 hover:text-gray-900"
