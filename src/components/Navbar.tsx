...
const Navbar: Component = () => {
  ...
  return (
    <nav
      class="flex-no-wrap relative flex w-full items-center justify-between bg-primary-red py-4 shadow-md shadow-black/5 dark:bg-primary-red dark:shadow-black/10 lg:flex-wrap lg:justify-start"
      data-te-navbar-ref
    >
